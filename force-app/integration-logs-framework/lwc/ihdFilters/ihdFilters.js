...
import IHD_Search_Context from "@salesforce/label/c.IHD_Search_Context";
import IHD_Search_Placeholder from "@salesforce/label/c.IHD_Search_Placeholder";
import IHD_Toggle_Filters from "@salesforce/label/c.IHD_Toggle_Filters";
...
import IHD_From from "@salesforce/label/c.IHD_From";
import IHD_To from "@salesforce/label/c.IHD_To";
import IHD_Clear_All_Filters from "@salesforce/label/c.IHD_Clear_All_Filters";
import IHD_Search_Help from "@salesforce/label/c.IHD_Search_Help";
import IHD_Updated from "@salesforce/label/c.IHD_Updated";

export default class IhdFilters extends LightningElement {
  labels = {
    IHD_Search_Context,
    IHD_Search_Placeholder,
    IHD_Toggle_Filters,
    IHD_Refresh_Data,
    IHD_Correlation_Id,
