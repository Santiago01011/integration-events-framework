...
import IEF_Tab_Integrations from "@salesforce/label/c.IEF_Tab_Integrations";
import IEF_Tab_Filters from "@salesforce/label/c.IEF_Tab_Filters";
import IEF_Tab_Admin from "@salesforce/label/c.IEF_Tab_Admin";
import IEF_System_Pulse from "@salesforce/label/c.IEF_System_Pulse";
import IEF_Loading from "@salesforce/label/c.IEF_Loading";
import IEF_Error_Loading_Summaries from "@salesforce/label/c.IEF_Error_Loading_Summaries";
import IEF_View_Grouped from "@salesforce/label/c.IEF_View_Grouped";
import IEF_View_Detailed from "@salesforce/label/c.IEF_View_Detailed";

const REFRESH_DEBOUNCE_MS = 1500;

export default class IefDashboard extends LightningElement {
  // Expose labels for template binding
  labels = {
    IEF_Tab_Summary,
    IEF_Tab_Integrations,
    IEF_Tab_Filters,
    IEF_Tab_Admin,
    IEF_System_Pulse,
    IEF_Loading,
    IEF_Error_Loading_Summaries,
    IEF_View_Grouped,
    IEF_View_Detailed
  };
  ...
  /**
   * @description Handles the 'filterschanged' event from c-ief-filters.
  ...
  async _refreshAllImmediate() {
    ...
    this.isLoading = true;
    try {
      const eventHub = this.template.querySelector("c-ief-event-hub");
      if (eventHub) {
        eventHub.refresh();
      }
  ...
  /**
   * @description Handles the 'rowaction' event from c-ief-table.
  ...
  /**
   * @description Handles the 'loadmore' event from c-ief-table.
   ...
   */
  focusSearchInput() {
    const filters = this.template.querySelector("c-ief-filters");
    if (filters) {
