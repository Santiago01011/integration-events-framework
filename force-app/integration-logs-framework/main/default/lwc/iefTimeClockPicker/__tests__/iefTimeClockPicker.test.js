...
import IefTimeClockPicker from "c/iefTimeClockPicker";

describe("c-ief-time-clock-picker", () => {
  afterEach(() => {
  ...
  it("displays default time 00:00 when no value is provided", () => {
    const element = createElement("c-ief-time-clock-picker", {
      is: IefTimeClockPicker
    });
