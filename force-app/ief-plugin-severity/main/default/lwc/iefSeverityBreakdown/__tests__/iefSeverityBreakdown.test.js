...
import IefSeverityBreakdown from "c/iefSeverityBreakdown";

describe("c-ief-severity-breakdown", () => {
  afterEach(() => {
  ...
  it("renders the card container with title", () => {
    const element = createElement("c-ief-severity-breakdown", {
      is: IefSeverityBreakdown
    });
