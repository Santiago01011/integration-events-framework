...
import IefTopErrorIntegrations from "c/iefTopErrorIntegrations";

describe("c-ief-top-error-integrations", () => {
  afterEach(() => {
  ...
  it("renders the card container with title", () => {
    const element = createElement("c-ief-top-error-integrations", {
      is: IefTopErrorIntegrations
    });
